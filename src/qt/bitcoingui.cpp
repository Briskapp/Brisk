                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Brisk Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BRSK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BRSK: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Brisk Core"), this);
    aboutAction->setStatusTip(tr("Show information about Brisk Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BRSK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BRSK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BRSK addresses"));
    ...
    openAction->setStatusTip(tr("Open a BRSK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Brisk Core help message to get a list with possible BRSK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Brisk Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BRSK network", "", count));
}
...
{
    QString strTitle = tr("Brisk Core"); // default title
