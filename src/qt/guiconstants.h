...
/* BRSK GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BRSK"
#define QAPP_ORG_DOMAIN "Brisk.com"
#define QAPP_APP_NAME_DEFAULT "BRSK-Qt"
#define QAPP_APP_NAME_TESTNET "BRSK-Qt-testnet"
