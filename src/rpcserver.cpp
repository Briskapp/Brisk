...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BRSK features */
        {"BRSK", "masternode", &masternode, true, true, false},
        {"BRSK", "listmasternodes", &listmasternodes, true, true, false},
        {"BRSK", "getmasternodecount", &getmasternodecount, true, true, false},
        {"BRSK", "masternodeconnect", &masternodeconnect, true, true, false},
        {"BRSK", "masternodecurrent", &masternodecurrent, true, true, false},
        {"BRSK", "masternodedebug", &masternodedebug, true, true, false},
        {"BRSK", "startmasternode", &startmasternode, true, true, false},
        {"BRSK", "createmasternodekey", &createmasternodekey, true, true, false},
        {"BRSK", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"BRSK", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"BRSK", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"BRSK", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"BRSK", "getmasternodescores", &getmasternodescores, true, true, false},
        {"BRSK", "mnbudget", &mnbudget, true, true, false},
        {"BRSK", "preparebudget", &preparebudget, true, true, false},
        {"BRSK", "submitbudget", &submitbudget, true, true, false},
        {"BRSK", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BRSK", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BRSK", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BRSK", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BRSK", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BRSK", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BRSK", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BRSK", "checkbudgets", &checkbudgets, true, true, false},
        {"BRSK", "mnsync", &mnsync, true, true, false},
        {"BRSK", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> BRSK-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17385/\n";
}
