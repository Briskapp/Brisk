...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Brisk Core BRSK-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  BRSK-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BRSK transaction") + "\n" +
                               "  BRSK-tx [options] -create [commands]   " + _("Create hex-encoded BRSK transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BRSK transaction
