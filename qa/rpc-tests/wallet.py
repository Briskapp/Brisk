...
#   c) node1 mines 32 blocks, so now node 0 has 500000BRSK, node 1 has 4250BRSK, node2 has none.
#   d) node0 sends 601 BRSK to node2, in two transactions (301 BRSK, then 300 BRSK).
