...
RESOURCES += src/qt/BRSK.qrc src/qt/BRSK_locale.qrc

TRANSLATIONS += src/qt/locale/BRSK_bg.ts \
                src/qt/locale/BRSK_de.ts \
                src/qt/locale/BRSK_en.ts \
                src/qt/locale/BRSK_es.ts \
                src/qt/locale/BRSK_fi.ts \
                src/qt/locale/BRSK_fr.ts \
                src/qt/locale/BRSK_it.ts \
                src/qt/locale/BRSK_ja.ts \
                src/qt/locale/BRSK_pl.ts \
                src/qt/locale/BRSK_pt.ts \
                src/qt/locale/BRSK_ru.ts \
                src/qt/locale/BRSK_sk.ts \
                src/qt/locale/BRSK_sv.ts \
                src/qt/locale/BRSK_vi.ts \
                src/qt/locale/BRSK_zh_CN.ts \
                src/qt/locale/BRSK_zh_TW.ts
