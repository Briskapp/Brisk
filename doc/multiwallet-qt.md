...
In order to support loading of multiple wallets in BRSK-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BRSK.cpp.
...
Changes to BRSK.cpp
----------------------
BRSK.cpp is the entry point into BRSK-qt, and as such, will require some minor modifications to provide hooks for
