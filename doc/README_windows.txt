...
Intro
-----
BRSK (BRSK) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BRSK utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run BRSK-qt.exe.

Brisk Core is the original BRSK client and it builds the backbone of the network.
However, it downloads and stores the entire history of BRSK transactions;
