Contributing to Brisk Core
==================================

The Brisk Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Brisk Core project, and is not to be
confused with overall BRSK Network Protocol consensus changes.

Whether a pull request is merged into Brisk Core rests with the project merge
...
Patches that change BRSK consensus rules are considerably more involved than
...
Where a patch set proposes to change the BRSK consensus, it must have been
...
The project leader is the release manager for each Brisk Core release.
